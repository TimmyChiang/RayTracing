...
- Optional: You can convert `image.ppm` to `image.png` by the following command.
    ```
    convert image.ppm image.png
    ```
    This requires the package `imagemagick`. For macOS, you can simply run the following command to install the package:
    ```
